...
protected:
	...
	bool 									bMouseOutside_;
    TransferFunctionLine::Vec2i 			v2iCursorPos_;
	...
	TransferFunctionLine::Vec2i				v2iSizeUI_;
	TransferFunctionLine::Vec2i				v2iSizeTfEdt_;
	TransferFunctionLine::Vec2i				v2iTopLeftCornerUI_;
	TransferFunctionLine::Vec2i				v2iTopLeftCorner_;
